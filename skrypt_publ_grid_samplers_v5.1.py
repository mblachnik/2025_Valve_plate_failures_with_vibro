...
bordersmote = BorderlineSMOTE(random_state=random_state)
...
samplers = ['smote', 'bordersmote', 'adasyn', 'rand_os', 'rand_us',
            'enn', 'tomeklinks', 'smote_enn', 'smote_tomek', 'pusta dupa']
        ...
        for name,model,param in models:
            for sampler in samplers:
                ...
                if sampler == 'smote':
                    ...
                    model_gs = make_pipeline(pm,bordersmote,model)
                    # param["smote__k_neighbors"] = [2,3,5,7,9]
                    param_gs["borderlinesmote__k_neighbors"] = [2,3,5,7,9,11]
                    param_gs["borderlinesmote__m_neighbors"] = [2,4,6,8,10,12]
                elif sampler == 'adasyn':
                    model_gs = make_pipeline(pm,adasyn,model)
                    # param["smote__k_neighbors"] = [2,3,5,7,9]
                    param_gs["adasyn__n_neighbors"] = [2,3,5,7,9,11]
                ...
                #     param_gs["nearmiss__n_neighbors_ver3"] = [2,3,5,7,9,11]
                    ...
                    model_gs = make_pipeline(pm,tomeklinks,model)
                    ...
                    model_gs = make_pipeline(pm,smotetomek,model)
                    # param_gs["smoteenn__smote__k_neighbors"] = [2,3,5,7,9,11]
                    param_gs["smotetomek__smote"] = [SMOTE(k_neighbors=2,random_state=random_state), SMOTE(k_neighbors=3,random_state=random_state), 
                                                    SMOTE(k_neighbors=5,random_state=random_state), SMOTE(k_neighbors=7,random_state=random_state),
                                                    SMOTE(k_neighbors=9,random_state=random_state), SMOTE(k_neighbors=11,random_state=random_state),
                                                    ]
                else:
